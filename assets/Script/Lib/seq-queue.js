 ...
 * @constructor
 */
var SeqQueue = function (timeout, isPause) {
...
/****** Django  */
SeqQueue.prototype.pause = function () {
    this.isPause = true;
    this.status = SeqQueueManager.STATUS_IDLE;
};

SeqQueue.prototype.resume = function () {
    this.isPause = false;
...
SeqQueue.prototype.clearAll = function () {
    if (this.timerId) {
...
SeqQueue.prototype.push = function (fn, ontimeout, timeout) {
    ...
    if (this.status === SeqQueueManager.STATUS_IDLE && !this.isPause) {
        this.status = SeqQueueManager.STATUS_BUSY;
        var self = this;
        process.nextTick(function () {
            self._next(self.curId);
...
SeqQueue.prototype._next = function (tid) {
    if (this.isPause || tid !== this.curId || this.status !== SeqQueueManager.STATUS_BUSY && this.status !== SeqQueueManager.STATUS_CLOSED) {
 ...
 * @memberOf SeqQueueManager
 */
SeqQueueManager.createQueue = function (timeout, isPause) {
    return new SeqQueue(timeout, isPause);
};
